...
const String devid = "v8331E80F9FDF743"; //device ID from Pushingbox 

const char* MY_SSID = "Hackland";
const char* MY_PWD =  "hackland1";
...
void loop()
{
  ...
  */
  ...
  float hicData =4;// dht.computeHeatIndex(celData, humidityData, false);
  // Compute heat index in Fahrenheit (the default)
  float hifData = 5;//dht.computeHeatIndex(fehrData, humidityData);
  */
