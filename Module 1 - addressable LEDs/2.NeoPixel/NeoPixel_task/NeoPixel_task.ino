...
void loop() {
  ...
  //TODO: Task 4a - Make the neopixels fade in adn out with hacklands colours. ie go 
      //from zero brightness to full brightness of one colour then do the same for the other colour.
